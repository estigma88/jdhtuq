...
public class RingDefinitionStep extends CucumberRoot {
    ...
    private void addNode(Ring ring, String node) {
        MessageClient messageClient = new MessageClient(integrationITProperties.getPortBy(node), restTemplate);
    ...
    public void destroyRing() throws StorageException, IOException, InterruptedException {
        ...
        FileUtils.deleteDirectory(new File(integrationITProperties.getDhash().getResourceDirectory()));
    }
}
