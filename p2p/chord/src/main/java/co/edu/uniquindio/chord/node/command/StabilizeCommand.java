...
/**
 * 
 * The <code>StabilizeCommand</code> class is responsible for executing the
 ...
 * @see StableRing
 */
public class StabilizeCommand extends ChordNodeCommand {
	/**
	 ...
	 */
	public StabilizeCommand(ChordNode nodeChord) {
		super(nodeChord);
	}
