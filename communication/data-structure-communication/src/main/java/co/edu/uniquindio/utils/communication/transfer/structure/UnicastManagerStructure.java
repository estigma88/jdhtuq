...
/**
 * The <code>UnicastManagerStructure</code> class is an
 * <code>Communicator</code>. Implements send messages unicast for data
 * structure
 * 
 ...
 * 
 */
public class UnicastManagerStructure extends TransferManagerStructure {
	...
	/**
	 * Builds a UnicastManagerStructure
	 * 
	 * @param communicationDataStructure
	 */
	public UnicastManagerStructure(
