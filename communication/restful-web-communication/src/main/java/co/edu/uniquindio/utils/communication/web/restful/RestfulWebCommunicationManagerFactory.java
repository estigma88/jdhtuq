...
public class RestfulWebCommunicationManagerFactory implements CommunicationManagerFactory {
    ...
    public RestfulWebCommunicationManagerFactory(RestTemplate restTemplate, Jackson2JsonObjectMapper jackson2JsonObjectMapper, String baseURL, String requestPath, int port, Observable<Message> observable, Map<String, Map<String, String>> paramsByCommunication, IntegrationFlowContext flowContext, MessageProcessorWrapper messageProcessorWrapper, ApplicationContext applicationContext) {
    ...
    public CommunicationManager newCommunicationManager(String name) {
        RestfulWebCommunicationManager restfulWebCommunicationClient = new RestfulWebCommunicationManager(name, restTemplate, jackson2JsonObjectMapper, baseURL, requestPath, port, observable, paramsByCommunication.get(name), flowContext, messageProcessorWrapper, applicationContext);
